...
- **Global scope**: `C:/Users/Amariin/Desktop/paulo-adv/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Amariin/Desktop/paulo-adv/.claude/notes/`)
...
2. Glob `C:/Users/Amariin/Desktop/paulo-adv/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Amariin/Desktop/paulo-adv/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Amariin/Desktop/paulo-adv/.claude/notes/` — works in any directory
